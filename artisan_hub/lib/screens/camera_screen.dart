        ...
        Wrap(
          ...
          children: [
            Container(
              ...
              child: Text("Photo Added", style: GoogleFonts.notoSans(fontSize: 10, fontWeight: FontWeight.bold, color: CraftTheme.tealTint)),
            ),
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
              decoration: BoxDecoration(color: CraftTheme.terracottaLight, borderRadius: BorderRadius.circular(6)),
              child: Text("Studio Enhancement Available", style: GoogleFonts.notoSans(fontSize: 10, fontWeight: FontWeight.bold, color: CraftTheme.terracottaPrimary)),
            ),
          ],
        ),
        const SizedBox(height: 14),
